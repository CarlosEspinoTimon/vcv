    ...
    projects = [
        new PersonalProject(
            ...
            [
                ...
                'The main idea of this project is for me to practise Angular, but as was doing it I thought that I could do it in a way that anyone could just fill some information in some files and it will have this virtual cv. I plan to write a post where I can show you how could use this as your CV just changing a few things.'
            ],
            'Angular 7',
